...
img1.addEventListener("mouseout", imgs)
img2.addEventListener("mouseout", imgs)
img3.addEventListener("mouseout", imgs)
img4.addEventListener("mouseout", imgs)
img5.addEventListener("mouseout", imgs)
